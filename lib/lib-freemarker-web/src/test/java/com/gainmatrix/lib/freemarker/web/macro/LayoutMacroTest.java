...
public class LayoutMacroTest extends AbstractWebMacroTest {
    ...
    public void test() throws Exception {
        ...
        TextTemplate textTemplate = freemarkerTextTemplateFactory.getTemplate("macro/layout/test-macros", null);
