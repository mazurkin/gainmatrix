...
public class JsExpressionValidatorTest {
    ...
    public void testInvalidBeanA() throws Exception {
        ...
        Assert.assertEquals("{com.gainmatrix.validator.constraints.Js.message}", violation.getMessage());
    ...
    @JsExpression("bean.value1 == bean.value2")
    ...
    @JsExpression.List({
        @JsExpression(value = "bean.value1 == bean.value2", message = "error.validation.mismatch"),
        @JsExpression(value = "bean.value1 == 'aaaaa'", message = "error.validation.wrong.value", subpath = "value1")
    })
    ...
    @JsExpression(value = "bean.isValid()", message = "error.validation.function")
